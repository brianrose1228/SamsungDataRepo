...
## Of the run_analysis code I originally submitted in the 3rd commit
## Since it was turned in after the deadline you should not use it for grading purposes
## Fixes a bug where the activity and subject labels were incorrectly set to the same value
## Otherwise the logic is unchanged
...
#create output file
setwd(directory)
write.table(TidyData, "SamsungTidyDataREVISED.txt", sep="\t")
